...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final ShaketraceLibraryAccessors laccForShaketraceLibraryAccessors = new ShaketraceLibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>shaketrace</b>
     */
    public ShaketraceLibraryAccessors getShaketrace() {
        return laccForShaketraceLibraryAccessors;
    }
    ...
    public static class ShaketraceLibraryAccessors extends SubDependencyFactory {

        public ShaketraceLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>compose</b> with <b>com.github.theRockAkash:shaketrace.compose</b> coordinates and
         * with version reference <b>shaketraceCompose</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getCompose() {
            return create("shaketrace.compose");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>shaketraceCompose</b> with value <b>v1.5.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getShaketraceCompose() { return getVersion("shaketraceCompose"); }
    ...
    public static class KotlinVersionAccessors extends VersionFactory  implements VersionNotationSupplier {
        ...
        /**
         * Version alias <b>kotlin.ksp</b> with value <b>2.0.21-1.0.27</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
