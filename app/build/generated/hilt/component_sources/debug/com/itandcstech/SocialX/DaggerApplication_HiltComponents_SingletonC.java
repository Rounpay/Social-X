package com.itandcstech.SocialX;
...
import com.itandcstech.SocialX.modules.auth.data.AuthRepo;
import com.itandcstech.SocialX.modules.auth.login.LoginViewModel;
import com.itandcstech.SocialX.modules.auth.login.LoginViewModel_HiltModules;
import com.itandcstech.SocialX.retrofit.Apis;
import com.itandcstech.SocialX.retrofit.Interceptor;
import com.itandcstech.SocialX.retrofit.NetworkModule;
import com.itandcstech.SocialX.retrofit.NetworkModule_GetRetrofitApiFactory;
import com.itandcstech.SocialX.util.NetworkManager;
import com.itandcstech.SocialX.util.PreferenceHelper;
...
public final class DaggerApplication_HiltComponents_SingletonC {
  ...
  private static final class ActivityCImpl extends Application_HiltComponents.ActivityC {
    ...
    public Map<Class<?>, Boolean> getViewModelKeys() {
      return LazyClassKeyMap.<Boolean>of(Collections.<String, Boolean>singletonMap(LazyClassKeyProvider.com_itandcstech_SocialX_modules_auth_login_LoginViewModel, LoginViewModel_HiltModules.KeyModule.provide()));
    }
    ...
    private static final class LazyClassKeyProvider {
      static String com_itandcstech_SocialX_modules_auth_login_LoginViewModel = "com.itandcstech.SocialX.modules.auth.login.LoginViewModel";

      @KeepFieldType
      LoginViewModel com_itandcstech_SocialX_modules_auth_login_LoginViewModel2;
    }
  }
  ...
  private static final class ViewModelCImpl extends Application_HiltComponents.ViewModelC {
    ...
    private AuthRepo authRepo() {
      return new AuthRepo(singletonCImpl.networkManagerProvider.get(), singletonCImpl.getRetrofitApiProvider.get());
    }
    ...
    public Map<Class<?>, javax.inject.Provider<ViewModel>> getHiltViewModelMap() {
      return LazyClassKeyMap.<javax.inject.Provider<ViewModel>>of(Collections.<String, javax.inject.Provider<ViewModel>>singletonMap(LazyClassKeyProvider.com_itandcstech_SocialX_modules_auth_login_LoginViewModel, ((Provider) loginViewModelProvider)));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.itandcstech.SocialX.modules.auth.login.LoginViewModel 
          return (T) new LoginViewModel(viewModelCImpl.authRepo());
  ...
  private static final class SingletonCImpl extends Application_HiltComponents.SingletonC {
    ...
    private Provider<Apis> getRetrofitApiProvider;
    ...
    private PreferenceHelper preferenceHelper() {
      return new PreferenceHelper(ApplicationContextModule_ProvideContextFactory.provideContext(applicationContextModule));
    }
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam,
      ...
      this.networkManagerProvider = DoubleCheck.provider(new SwitchingProvider<NetworkManager>(singletonCImpl, 0));
      this.getRetrofitApiProvider = DoubleCheck.provider(new SwitchingProvider<Apis>(singletonCImpl, 1));
    }
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // com.itandcstech.SocialX.util.NetworkManager 
          ...
          case 1: // com.itandcstech.SocialX.retrofit.Apis 
          return (T) NetworkModule_GetRetrofitApiFactory.getRetrofitApi(singletonCImpl.networkModule, singletonCImpl.interceptor(), ApplicationContextModule_ProvideContextFactory.provideContext(singletonCImpl.applicationContextModule));
